	...
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
							...
							<div class="col-md-6">
								...
								<select id="subCategory" name="subCategory" class="form-control"  required>
									...
									@if ($errors->has('subCategory'))
									    <small class="form-control-feedback text-danger">{{ $errors->first('subCategory') }}</small>
									@endif
					...
					<div class="row p-t-20">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" id="manufacturerName" name="manufacturerName" class="form-control" placeholder="" required disabled>
									
									@if ($errors->has('manufacturerName'))
									    <small class="form-control-feedback text-danger">{{ $errors->first('manufacturerName') }}</small>
									@endif
				...
				<br>
			<h3 style="margin-left: 10px;">All Manufacturer</h3>
			...
			<table class="table" id="example23" style="margin-left: 10px;">
			  ...
			  <tbody>
			  	@foreach(App\Manufacture::all() as $index => $mc)
			    <tr>
				  ...
				  <div class="modal-dialog modal-dialog-centered" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				        <form action="{{route('manufacturer.update',$mc->id)}}" method="post">
				        	@csrf
				        	{{method_field('PUT')}}
				        	<div class="form-group">
...
<script>
    ...
    $('#category').on('change', e => {
        document.getElementById("manufacturerName").removeAttribute("disabled");
    });
</script>
