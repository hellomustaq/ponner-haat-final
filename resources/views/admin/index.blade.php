                        ...
                        <div class="weather-card one">
                            <div class="top">
                                <div class="wrapper">
                                    ...
                                    <h3 class="location">{{$response->name}}, {{$response->sys->country}} </h3>
                                    
                                    <p class="temp">
                                        <span class="temp-value">{{$response->main->temp}}</span>
                            ...
                            <div class="bottom">
                                <div class="wrapper">
                                    <ul class="forecast">
                                        ...
                                        <li class="active">
                                            <span class="date">Sunrise</span>
                                            <span class="lnr lnr-sun condition">
                                                <span class="temp">{{date('h:i:s a',$response->sys->sunrise)}}</span></span>
                                            </span>
                                        </li>
                                        <li class="active">
                                            <span class="date">Sunset</span>
                                            <span class="lnr lnr-cloud condition">
                                                <span class="temp">{{date('h:i:s a',$response->sys->sunset)}}</span>
                                            </span>
                                        </li>
                                    </ul>
                                </div>
